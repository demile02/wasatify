...
export function StudentDashboard() {
  return (
    <DashboardLayout role="student" title="Belajar Islam Wasathiyah" subtitle="Jadi generasi moderat, cerdas, dan berakhlak mulia.">
      <div className="grid gap-6 xl:grid-cols-[1.45fr_0.75fr]">
          ...
          <Card className="overflow-hidden p-0">
            <div className="grid md:grid-cols-[1fr_270px]">
              <div className="p-6">
                ...
                <h2 className="mt-2 font-display text-2xl font-extrabold">Prinsip Moderasi Beragama</h2>
                <p className="mt-2 text-sm text-slate-500">Selesaikan materi tawazun dan tasamuh, lalu lanjut ke refleksi singkat.</p>
                ...
                <div className="mt-4 flex items-center justify-between text-sm">
                  <span className="font-bold text-emerald-700">60% selesai</span>
        ...
        <aside className="space-y-6 pb-20 lg:pb-0">
          <Card>
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="font-display text-3xl font-extrabold">12 hari</p>
          ...
          <Card>
            <ProgressRing value={50} label="Progress Belajar" />
