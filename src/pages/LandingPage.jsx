    ...
    <PageTransition>
      <div className="min-h-screen bg-[#fbfaf6] text-ink">
        <section className="pattern px-4 py-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-7xl overflow-hidden rounded-[2rem] border border-emerald-900/10 bg-white/86 shadow-soft">
            ...
            <div className="grid items-center gap-8 px-5 pb-6 pt-6 md:px-8 lg:grid-cols-[1fr_1.05fr] lg:pb-10">
              <div>
                <motion.div
                  ...
                  {features.map((feature) => {
                    ...
                    return (
                      <div key={feature.title} className="text-center sm:text-left">
                        <div className="mb-3 inline-grid h-12 w-12 place-items-center rounded-2xl bg-emerald-50 text-emerald-700">
                ...
                <div className="mt-8 flex flex-wrap gap-4">
                  <Link to="/register">
                    <Button>Mulai Belajar <ArrowRight className="h-4 w-4" /></Button>
                  </Link>
                  <a href="#fitur">
              ...
              {modules.slice(0, 6).map((module) => (
                <Card key={module.id}>
                  <div className="mb-4 flex items-center justify-between">
                    <span className="rounded-full bg-emerald-50 px-3 py-1 text-xs font-bold text-emerald-700">Modul {module.id}</span>
                    <span className="text-xs font-semibold text-slate-400">{module.duration}</span>
                  </div>
